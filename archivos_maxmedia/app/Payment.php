...
class Payment extends Model {
     ...
     * @var array
     */
    protected $fillable = ['earning', 'paid', 'referal','balance','user_id','created_at','updated_at'];
...
public static function revenue_dia(){
    ...
    public static function solicitar(){
        return $datos = DB::table('orders')
            ...
            ->whereBetween('orders.created_at',[\Carbon\Carbon::now()->subMonth(1),\Carbon\Carbon::now()])
