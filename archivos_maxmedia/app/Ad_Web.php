...
class Ad_Web extends Model {
    ...
    return  $ads = DB::table('ad__webs')
            ...
            ->select('ad__webs.nombre as n','users.*','webs.*','webs.nombre as w_nombre','users.email as email','ad__webs.script as s','ads.nombre as n_ad','ads.tipo as tipo','ad__webs.id as id_ad')
            ->get();
    }
