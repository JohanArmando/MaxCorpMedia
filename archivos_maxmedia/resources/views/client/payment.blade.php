                    ...
                    <div class="widget widget-nopad">
                        ...
                        <div class="widget-content">
                            <div class="widget big-stats-container">
                                <div class="widget-content">
                                    <div id="big_stats">
                                        <div class="stat"> <i class="icon-money"></i> <span class="value">@foreach($revenue_dia as $r)@if($r->re <= 0 ) 0 @else{{ $r->re }}@endif @endforeach</span> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                @foreach($revenue as $r)
                    @foreach($solicitudes as $re)                
                        @foreach($payments as $payment) 
                            ...
                            <div class="widget widget-nopad">
                                <button type="button" class="btn btn-default" style="width: 270px;" data-target="#Mymodal" data-toggle="modal">Revenue</button>
                            </div>
                            @else
                             <div class="widget widget-nopad">
                                <button type="button" class="btn btn-warning" style="width: 270px;">You don't have enought money</button>
                            </div>
                            @endif
                        @endforeach
                    @endforeach
    ...
    $(document).ready(function($) {
        $('#t_payments').DataTable({
            language: {
                ...
                "info": "List Payments _PAGE_ de _PAGE_",
