    ...
    <div class="container">
        ...
        <div class="col-md-3">
            ...
            <div class="col-md-6">
                ...
                <h1 class="text-center">For your comments or requests it is important</h1><div class="section">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <form role="form" action="{{ route('mail.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="last-name">Regional Information</label>
                                        <select class="form-control" id="element_5_6" name="element_5_6" style="width: 560px;"> 
                                    ...
                                    <div class="fm-group">
                                        <label class="control-label" for="content">Paypal</label>
                                    ...
                                    <div class="form-group">
                                        <label for="control-label" for="web_site">Web Site where the ad will be placed</label>
